...
class AppBottomNavTheme {
  ...
  /// 选中文字颜色
  static const Color selectedLabelLight = Color(0xFF07C160);
  ...
  /// 中央发布按钮
  static const double publishButtonWidth = 44;
  static const double publishButtonHeight = 30;
  static const double publishButtonBorderRadius = 8;
  static const double publishButtonBorderWidth = 1.8;
  static const double publishButtonIconSize = 22;
  static const Color publishButtonColorLight = Color(0xFF333333);
